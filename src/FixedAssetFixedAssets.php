...
use PhpTwinfield\Fields\Level1234\Level34\FixedAsset\FixedAssetsMethodField;
use PhpTwinfield\Fields\Level1234\Level34\FixedAsset\FixedAssetsMethodLockedField;
use PhpTwinfield\Fields\Level1234\Level34\FixedAsset\FixedAssetsStatusField;
use PhpTwinfield\Fields\Level1234\Level34\FixedAsset\FixedAssetsStatusLockedField;
...
class FixedAssetFixedAssets extends BaseObject
{
    ...
    use FixedAssetsMethodField;
    use FixedAssetsMethodLockedField;
    use FixedAssetsStatusField;
    use FixedAssetsStatusLockedField;
    use FreeText1Field;
