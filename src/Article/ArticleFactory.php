...
class ArticleFactory extends ParentFactory
{
     ...
     * \PhpTwinfield\Article\Article instance, made by the
     * \PhpTwinfield\Article\Mapper\ArticleMapper class.
     * 
     * @access public
     * @param int $code
     * @param int $office
     * @return \PhpTwinfield\Article\Article | false
     */
    ...
    /**
     * Sends a \PhpTwinfield\Article\Article instance to Twinfield
     * to update or add.
     * 
     ...
     * \PhpTwinfield\Customer\DOM\ArticleDocument where it will
     ...
     * 
     * @access public
     * @param \PhpTwinfield\Article\Article $article
     * @return boolean
     */
