...
/**
 * Used to request a specific DimensionGroup from a certain office and code.
 *
 ...
 * @version 0.0.1
 */
class DimensionGroup extends DOMDocument
{
    /**
     * Holds the <dimensiongroup> element that all
     ...
     * dimensionGroupElement and sets office and code if they are present.
     *
     * @access public
     */
    ...
    /**
     * Adds additional elements to the <dimensiongroup> dom element.
     *
     * See the documentation over what <dimensiongroup> requires to know
    ...
    protected function add($element, $value)
    {
        ...
        $this->dimensionGroupElement->appendChild($_element);
    }

    /**
     * Sets the office code for this DimensionGroup request.
     *
     * @access public
     * @param int $office
     * @return \PhpTwinfield\Request\Read\DimensionGroup
     */
    ...
    /**
     * Sets the code for this DimensionGroup request.
     *
     * @access public
     * @param string $code
     * @return \PhpTwinfield\Request\Read\DimensionGroup
