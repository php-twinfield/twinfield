<?php
namespace PhpTwinfield\Customer\Mapper;

use \PhpTwinfield\Customer\Customer;
use \PhpTwinfield\Customer\CustomerAddress;
use \PhpTwinfield\Customer\CustomerBank;
...
class CustomerMapper
{
     ...
     * @return \PhpTwinfield\Customer\Customer
     */
    public static function map(Response $response)
    {
        ...
        $customer->setCreditManagement(new \PhpTwinfield\Customer\CustomerCreditManagement());
