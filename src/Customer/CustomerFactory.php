...
class CustomerFactory extends ParentFactory
{
     ...
     * \PhpTwinfield\Customer\Customer instance, made by the
     * \PhpTwinfield\Customer\Mapper\CustomerMapper class.
     * 
     * @access public
     * @param int $code
     * @param int $office
     * @return \PhpTwinfield\Customer\Customer | false
     */
    ...
    /**
     * Sends a \PhpTwinfield\Customer\Customer instance to Twinfield
     * to update or add.
     * 
     ...
     * \PhpTwinfield\Customer\DOM\CustomersDocument where it will
     ...
     * 
     * @access public
     * @param \PhpTwinfield\Customer\Customer $customer
     * @return boolean
     */
