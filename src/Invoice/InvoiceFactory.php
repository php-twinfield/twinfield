...
class InvoiceFactory extends ParentFactory
{
     ...
     * \PhpTwinfield\Invoice\Invoice instance, made by the
     * \PhpTwinfield\Invoice\Mapper\InvoiceMapper class.
     * 
     * @access public
     * @param string $code
    ...
    /**
     * Sends a \PhpTwinfield\Invoice\Invoice instance to Twinfield
     * to update or add.
     * 
     ...
     * \PhpTwinfield\Invoice\DOM\InvoicesDocument where it will
     ...
     * 
     * @access public
     * @param \PhpTwinfield\Invoice\Invoice $invoice
     * @return boolean
     */
