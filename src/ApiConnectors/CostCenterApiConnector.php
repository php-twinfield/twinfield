...
class CostCenterApiConnector extends BaseApiConnector
{
    ...
    public function listAll(
        ...
        $optionsArrayOfString['ArrayOfString'][] = array("dimtype", "KPL");
        ...
        foreach ($response->data->Items->ArrayOfString as $costCenterArray) {
            ...
            if (isset($costCenterArray->string[0])) {
                $costCenter->setCode($costCenterArray->string[0]);
                $costCenter->setName($costCenterArray->string[1]);
            } else {
                $costCenter->setCode($costCenterArray[0]);
                $costCenter->setName($costCenterArray[1]);
            }
