...
class CurrencyApiConnector extends BaseApiConnector
{
    ...
    */
    ...
    public function listAll(
        ...
        foreach ($response->data->Items->ArrayOfString as $currencyArray) {
            $currency = new Currency();

            if (isset($currencyArray->string[0])) {
                $currency->setCode($currencyArray->string[0]);
                $currency->setName($currencyArray->string[1]);
            } else {
                $currency->setCode($currencyArray[0]);
                $currency->setName($currencyArray[1]);
            }
