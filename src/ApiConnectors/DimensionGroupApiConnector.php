...
class DimensionGroupApiConnector extends BaseApiConnector
{
    ...
    public function listAll(
        ...
        foreach ($response->data->Items->ArrayOfString as $dimensionGroupArray) {
            $dimensionGroup = new DimensionGroup();

            if (isset($dimensionGroupArray->string[0])) {
                $dimensionGroup->setCode($dimensionGroupArray->string[0]);
                $dimensionGroup->setName($dimensionGroupArray->string[1]);
            } else {
                $dimensionGroup->setCode($dimensionGroupArray[0]);
                $dimensionGroup->setName($dimensionGroupArray[1]);
            }
