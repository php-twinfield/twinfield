            ...
            if (isset($transactionLinesDOMTag) && $transactionLinesDOMTag->length > 0) {
                ...
                foreach ($transactionLinesDOMTag->item(0)->childNodes as $transactionLineElement) {
                    ...
                    $fixedAssetTransactionLine->setAmount(self::parseMoneyAttribute(self::getField($transactionLineElement, 'amount', $fixedAssetTransactionLine)))
                        ...
                        ->setDim2(self::parseObjectAttribute(\PhpTwinfield\UnknownDimension::class, $fixedAssetTransactionLine, $transactionLineElement, 'dim2', array('name' => 'setName', 'shortname' => 'setShortName', 'dimensiontype' => 'setType')))
                        ->setDim3(self::parseObjectAttribute(\PhpTwinfield\UnknownDimension::class, $fixedAssetTransactionLine, $transactionLineElement, 'dim3', array('name' => 'setName', 'shortname' => 'setShortName', 'dimensiontype' => 'setType')))
                        ->setDim4(self::parseObjectAttribute(\PhpTwinfield\UnknownDimension::class, $fixedAssetTransactionLine, $transactionLineElement, 'dim4', array('name' => 'setName', 'shortname' => 'setShortName', 'dimensiontype' => 'setType')))
                        ->setDim5(self::parseObjectAttribute(\PhpTwinfield\UnknownDimension::class, $fixedAssetTransactionLine, $transactionLineElement, 'dim5', array('name' => 'setName', 'shortname' => 'setShortName', 'dimensiontype' => 'setType')))
                        ->setDim6(self::parseObjectAttribute(\PhpTwinfield\UnknownDimension::class, $fixedAssetTransactionLine, $transactionLineElement, 'dim6', array('name' => 'setName', 'shortname' => 'setShortName', 'dimensiontype' => 'setType')))
