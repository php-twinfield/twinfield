            ...
            if (isset($transactionLinesDOMTag) && $transactionLinesDOMTag->length > 0) {
                ...
                foreach ($transactionLinesDOMTag->item(0)->childNodes as $transactionLineElement) {
                    ...
                    $fixedAssetTransactionLine->setAmount(self::parseMoneyAttribute(self::getField($transactionLineElement, 'amount', $fixedAssetTransactionLine), $currencies['base']))
                        ...
                        ->setDim2(self::parseObjectAttribute('UnknownDimension', $fixedAssetTransactionLine, $transactionLineElement, 'dim2', array('name' => 'setName', 'shortname' => 'setShortName', 'dimensiontype' => 'setType'), true))
                        ->setDim3(self::parseObjectAttribute('UnknownDimension', $fixedAssetTransactionLine, $transactionLineElement, 'dim3', array('name' => 'setName', 'shortname' => 'setShortName', 'dimensiontype' => 'setType'), true))
                        ->setDim4(self::parseObjectAttribute('UnknownDimension', $fixedAssetTransactionLine, $transactionLineElement, 'dim4', array('name' => 'setName', 'shortname' => 'setShortName', 'dimensiontype' => 'setType'), true))
                        ->setDim5(self::parseObjectAttribute('UnknownDimension', $fixedAssetTransactionLine, $transactionLineElement, 'dim5', array('name' => 'setName', 'shortname' => 'setShortName', 'dimensiontype' => 'setType'), true))
                        ->setDim6(self::parseObjectAttribute('UnknownDimension', $fixedAssetTransactionLine, $transactionLineElement, 'dim6', array('name' => 'setName', 'shortname' => 'setShortName', 'dimensiontype' => 'setType'), true))
