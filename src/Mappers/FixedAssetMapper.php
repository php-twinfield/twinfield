...
class FixedAssetMapper extends BaseMapper
{
    ...
    public static function map(Response $response)
    {
        ...
        $fixedAsset->setBehaviour(self::parseEnumAttribute('Behaviour', self::getField($fixedAssetElement, 'behaviour', $fixedAsset)))
        ...
        if ($financialsElement !== null) {
            ...
            $fixedAssetFinancials->setAccountType(self::parseEnumAttribute('AccountType', self::getField($financialsElement, 'accounttype', $fixedAssetFinancials)))
                ->setLevel(self::getField($financialsElement, 'level', $fixedAssetFinancials))
                ->setMatchType(self::parseEnumAttribute('MatchType', self::getField($financialsElement, 'matchtype', $fixedAssetFinancials)))
                ->setSubAnalyse(self::parseEnumAttribute('SubAnalyse', self::getField($financialsElement, 'subanalyse', $fixedAssetFinancials)))
        ...
        if ($fixedAssetsElement !== null) {
            ...
            $fixedAssetFixedAssets->setBeginPeriod(self::getField($fixedAssetsElement, 'beginperiod', $fixedAssetFixedAssets))
                ...
                ->setStatus(self::parseEnumAttribute('FixedAssetsStatus', self::getField($fixedAssetsElement, 'status', $fixedAssetFixedAssets)))
