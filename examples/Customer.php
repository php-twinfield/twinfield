...
if ($executeRead) {
    ...
    echo "BaseCreditLimit (string): " . Util::formatMoney($customerCreditManagement->getBaseCreditLimit()) . "<br />";                              // string|null
    ...
    echo "Blocked (string): " . Util::formatBoolean($customerCreditManagement->getBlocked()) . "<br />";                                            // string|null
    echo "Blocked Locked (bool): {$customerCreditManagement->getBlockedLocked()}<br />";                                                            // bool|null
    echo "Blocked Locked (string): " . Util::formatBoolean($customerCreditManagement->getBlockedLocked()) . "<br />";                               // string|null
    ...
    echo "Blocked Modified (string): " . Util::formatBoolean($customerCreditManagement->getBlockedModified()) . "<br />";                           // string|null
    ...
    echo "ResponsibleUser (string): " . Util::objectToStr($customerCreditManagement->getResponsibleUser()) . "<br />";                              // string|null
    ...
    echo "PayAvailable (string): " . Util::formatBoolean($customerFinancials->getPayAvailable()) . "<br />";                                        // string|null
    ...
    echo "PayCode (string): " . Util::objectToStr($customerFinancials->getPayCode()) . "<br />";                                                    // string|null
    ...
    echo "SubstituteWith (\\PhpTwinfield\\GeneralLedger): <pre>" . print_r($customerFinancials->getSubstituteWith(), true) . "</pre><br />";        // GeneralLedger|null               Default customer balancesheet account.
    echo "SubstituteWith (string): " . Util::objectToStr($customerFinancials->getSubstituteWith()) . "<br />";                                      // string|null
    ...
    echo "VatCode (string): " . Util::objectToStr($customerFinancials->getVatCode()) . "<br />";                                                    // string|null
    echo "VatCode Fixed (bool): {$customerFinancials->getVatCodeFixed()}<br />";                                                                    // bool|null
    echo "VatCode Fixed (string): " . Util::formatBoolean($customerFinancials->getVatCodeFixed()) . "<br />";                                       // string|null
    ...
    echo "SignatureDate (string): " . Util::formatDate($customerCollectMandate->getSignatureDate()) . "<br />";                                     // string|null
    ...
    foreach ($customerPostingRules as $key => $customerPostingRule) {
        ...
        echo "Amount (string): " . Util::formatMoney($customerPostingRule->getAmount()) . "<br />";                                                 // string|null
        echo "Currency (\\PhpTwinfield\\Currency): <pre>" . print_r($customerPostingRule->getCurrency(), true) . "</pre><br />";                    // Currency|null                    Currency.
        echo "Currency (string): " . Util::objectToStr($customerPostingRule->getCurrency()) . "<br />";                                             // string|null
        ...
        foreach ($customerLines as $key => $customerLine) {
            ...
            echo "Dimension1 (string): " . Util::objectToStr($customerLine->getDimension1()) . "<br />";                                            // string|null
            ...
            echo "Dimension2 (string): " . Util::objectToStr($customerLine->getDimension2()) . "<br />";                                            // string|null
            echo "Dimension2ID: {$customerLine->getDimension2ID()}<br />";                                                                          // string|null
            echo "Dimension3: <pre>" . print_r($customerLine->getDimension3(), true) . "</pre><br />";                                              // Project|Activity|null            Project or asset.
            ...
            echo "VatCode (string): " . Util::objectToStr($customerLine->getVatCode()) . "<br />";                                                  // string|null
        }
    }
}
...
if ($executeNew) {
    ...
    $customer->setOffice(\PhpTwinfield\Office::fromCode($officeCode));                                                                              // string|null
    ...
    $customer->setDiscountArticle(\PhpTwinfield\Article::fromCode("9060"));                                                                         // string|null
    ...
    //$customer->setGroup(\PhpTwinfield\DimensionGroup::fromCode("DIMGROUP"));                                                                      // string|null
    ...
    $customerCreditManagement->setBaseCreditLimit(\Money\Money::EUR(1000000));                                                                      // Money|null                       The credit limit amount. (Equals 10000.00 EUR)
    ...
    $customerCreditManagement->setResponsibleUser(\PhpTwinfield\User::fromCode('TWINAPPS'));                                                        // string|null
    ...
    $customerFinancials->setPayCode(\PhpTwinfield\PayCode::fromCode('SEPANLCT'));                                                                   // string|null
    ...
    $customerFinancials->setSubstituteWith(\PhpTwinfield\GeneralLedger::fromCode('1535'));                                                          // string|null
    $vatCode = new \PhpTwinfield\VatCode;
    $vatCode->setCode('VH');
    $customerFinancials->setVatCode($vatCode);                                                                                                      // VatCode|null                     Default VAT code.
    $customerFinancials->setVatCode(\PhpTwinfield\VatCode::fromCode('VH'));                                                                         // string|null
    ...
    $customerCollectMandate->setFirstRunDate(Util::parseDate('20190701'));                                                                          // string|null
    ...
    $customerCollectMandate->setSignatureDate(Util::parseDate('20190701'));                                                                         // string|null
    ...
    $customerBank->setCountry(\PhpTwinfield\Country::fromCode('NL'));                                                                               // string|null
    ...
    $customerPostingRule->setAmount(\Money\Money::EUR(10000));                                                                                      // Money|null                       Amount. (Equals 100.00 EUR)
    $currency = new \PhpTwinfield\Currency;
    $currency->setCode('EUR');
    $customerPostingRule->setCurrency($currency);                                                                                                   // Currency|null                    Currency.
    $customerPostingRule->setCurrency(\PhpTwinfield\Currency::fromCode('EUR'));                                                                     // string|null
    ...
    $customerLine->setDimension1(\PhpTwinfield\GeneralLedger::fromCode('1535'));                                                                    // string|null
    ...
    $customerLine->setDimension2(\PhpTwinfield\CostCenter::fromCode('00000'));                                                                      // string|null
    $activity = new \PhpTwinfield\Activity;
    $activity->setCode('P0000');
    $customerLine->setDimension3($activity);                                                                                                        // Project|Activity|null            Project or asset.
    $customerLine->setDimension3(\PhpTwinfield\Activity::fromCode('P0000'));                                                                        // string|null
    ...
    //$customerLine->setOffice(\PhpTwinfield\Office::fromCode('NLA0000001'));                                                                       // string|null
    ...
    $customerLine->setVatCode(\PhpTwinfield\VatCode::fromCode('VH'));                                                                               // string|null
